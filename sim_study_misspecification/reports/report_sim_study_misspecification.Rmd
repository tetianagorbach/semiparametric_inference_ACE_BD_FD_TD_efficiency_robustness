...
```{r, read results}
load("../results/sim_study_misspecification_res2021_07_19_11_29_04.Rdata")
...
p <- sim.results.long %>%
  ...
  geom_boxplot() +
  scale_fill_manual(values = alpha(cbbPalette, .8)) +
...
```{r, echo = F}
# are bounds in the confidene intervals constructed from empirical variances?
